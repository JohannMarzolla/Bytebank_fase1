...
export default function Footer(options: FooterOptions) {
  return (
    <>
      {!options?.session && (
        <footer className="bg-black text-white mx-auto w-full py-7">
          <div className="max-w-6xl mx-auto w-full flex flex-col sm:flex-row items-center sm:justify-between sm:justify-center gap-8">
            <div className="flex flex-col">
              <h3 className="font-bold text-[16px] leading-[19.2px] font-inter mb-2 w-[230px]">Serviços</h3>
            ...
            <div className="flex flex-col">
              <h3 className="font-bold text-[16px] leading-[19.2px] font-inter mb-2 w-[230px]">Contato</h3>
              <ul className="space-y-3 text-left">
            ...
            <div className="flex flex-col items-start gap-2">
              <p className="font-bold text-[16px] leading-[19.2px] font-inter w-[230px]">Desenvolvido por Alura</p>
