...
<footer className="bg-black text-white mx-auto w-full py-6">
  <div className="max-w-6xl mx-auto w-full flex flex-col sm:flex-row md:justify-between sm:justify-center"> {/* Added sm:justify-center */}

    <div className="flex flex-col">
      <h3 className="font-bold text-[16px] leading-[19.2px] font-inter mb-2">
        Serviços
      </h3>
      <ul className="space-y-3 text-left"> 
        <li className="font-normal text-[16px] leading-[19.2px] font-inter">
          Conta corrente
        </li>
        <li className="font-normal text-[16px] leading-[19.2px] font-inter">
          Conta PJ
