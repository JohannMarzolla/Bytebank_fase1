export default async function Home() {
  return (
    <div className="bg-[url('/bg-blue.svg')] bg-cover bg-center h-screen">
      <div className="flex items-center justify-between max-w-6xl mx-auto w-full mt-10">
        <h1 className="text-2xl font-bold text-black">
          Experimente mais liberdade no <br /> controle da sua vida financeira.{" "}
          <br /> Crie sua conta com a gente!
        </h1>
        <img src="/ilustracao-banner.svg" alt="" />
      </div>
      <div className="flex flex-wrap justify-between max-w-6xl mx-auto w-full mt-10">
        ...
        <div className="flex flex-col items-center w-1/4 p-4">
          ...
          <h2 className="text-lg font-bold text-[#47A138] font-inter text-[20px]  flex items-center mb-1">Saques sem custo</h2>
          <p className="text-center text-[#767676] w-[280px] h-[57px] font-inter font-normal text-[16px] leading-[120%] flex items-center">
        ...
        <div className="flex flex-col items-center w-1/4 p-4">
          ...
          <h2 className="text-lg font-bold text-[#47A138] font-inter text-[20px]  flex items-center mb1">Programa de pontos</h2>
          <p className="text-center text-[#767676] w-[280px] h-[57px] font-inter font-normal text-[16px] leading-[120%] flex items-center">
        ...
        <div className="flex flex-col items-center w-1/4 p-4">
          <img
            ...
            className="mb-2"
          />
          <h2 className="text-lg font-bold text-[#47A138] font-inter text-[20px]  flex items-center mb-1">Seguro Dispositivos</h2>
          <p className="text-center text-[#767676] w-[280px] h-[57px] font-inter font-normal text-[16px] leading-[120%] flex items-center">
